...
#' directly (subject to \code{burnin}/\code{thin}) -- this case is fast,
#' since no new sampling is needed. Otherwise, new draws are sampled for
#' the new locations and/or predictor values, which takes longer.
#'
