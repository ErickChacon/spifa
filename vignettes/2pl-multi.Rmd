...
samples_params_summary$theta <- samples_params_summary$theta %>%
  mutate(
    ...
    param3 = c(unique(data_long$ability2), unique(data_long$ability1)),
    param4 = - c(unique(data_long$ability2), unique(data_long$ability1)),
         )
samples_params_summary$a <- samples_params_summary$a %>%
  mutate(
    ...
    param3 = c(discrimination2, discrimination1),
    param4 = - c(discrimination2, discrimination1),
         )
