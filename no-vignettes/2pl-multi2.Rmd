...
system.time(
samples <- spmirt(
  response = data_long$y, predictors = matrix(1, 10, 2), coordinates = matrix(1, 10, 2),
  nobs = n, nitems = q, nfactors = 3, niter = iter,
  A_opt = list(prior_mean = NULL, prior_sd = NULL),
  constrains = list(W = matrix(1, 3, 3))
)
)
